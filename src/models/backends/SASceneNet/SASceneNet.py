...
class SASceneNet_Semantic_Only(nn.Module):
...
class SASceneNet_RGB_Only(nn.Module):
    def __init__(self, arch, scene_classes):
        super().__init__()
...
class SASceneNet_SemanticAndRGB(nn.Module):
    """
